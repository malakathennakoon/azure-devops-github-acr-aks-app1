...
if($_POST) //run only if there's a post data
{
	...
	$mregion		= filter_var($_POST["region"], FILTER_SANITIZE_STRING);
	
	$query = mysqli_query($con, "INSERT INTO binReqFeedBack_tbl (cemail, latitude, longitude, biodegradable, plastic, paper, glass, BinAvailable, status, region) VALUES ('$login_email', '$mLat', '$mLng', '$mbio', '$mpl', '$mpa', '$mgl', '$mType', 'Approval_Pending', '$mregion')");
	if(!$query)
	{
	...
	exit();*/
		...
		$rad1 		= filter_var($_POST["bio"], FILTER_SANITIZE_STRING);
		$rad4 		= filter_var($_POST["glass"], FILTER_SANITIZE_STRING);
		$rad3 		= filter_var($_POST["paper"], FILTER_SANITIZE_STRING);
		$rad2 		= filter_var($_POST["plastic"], FILTER_SANITIZE_STRING);
		$rad5		= filter_var($_POST["type"], FILTER_SANITIZE_STRING);
		$feedbacktype1		= filter_var($_POST["region"], FILTER_SANITIZE_STRING);
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////	 
		...
		$sql25 = "SELECT * sun_binLevel_tbl WHERE binID='$secondNearest';";
				...
				{
				//echo "<br>";
				$sql = "INSERT INTO binReqFeedBack_tbl (cemail, latitude, longitude, nearBin_1, nearBin_2, biodegradable, plastic, paper, glass, BinAvailable, binconfirm, region) VALUES ('$login_email', '$lat', '$lon', '$firstNearest', '$secondNearest', '$rad1', '$rad2', '$rad3', '$rad4', '$rad5', '$yes', '$spinn')";
				//echo "success";
				}
				else
				{
				//echo "<br>";
				$sql = "INSERT INTO binReqFeedBack_tbl (cemail, latitude, longitude, nearBin_1, nearBin_2, biodegradable, plastic, paper, glass, BinAvailable, binconfirm, region) VALUES ('$login_email', '$lat', '$lon', '$firstNearest', '$secondNearest', '$rad1', '$rad2', '$rad3', '$rad4', '$rad5', '$no', '$spinn')";
				//echo "noo";
				}
