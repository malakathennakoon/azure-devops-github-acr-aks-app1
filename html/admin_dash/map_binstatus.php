            ...
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    <div class="navbar-header">
                        <a class="navbar-brand" href="#"> Bin Status Monitoring </a>
                    </div>
...
<!--  Google Maps Plugin    -->
<script type="text/javascript" src="http://maps.googleapis.com/maps/api/js?key=AIzaSyDIVoB6zVRoEVqSUcmG9OVfg_LTe_FVDLs&sensor=false"></script>
					...
					clearOverlays();
						$.get("map_process.php", function (data) {
							$(data).find("marker").each(function () {
								  ...
								  if(filedlevel<80)
								  {
									create_marker(point, binid, filedlevel, false, false, false, "icons/50.png"); 
								  }
								  else if(filedlevel>80 && filedlevel<100)
								  {
									  create_marker(point, binid, filedlevel, false, false, false, "icons/70.png");
								  }
								  else if(filedlevel=100)
								  {
									  create_marker(point, binid, filedlevel, false, false, false, "icons/80.png");
								  }
