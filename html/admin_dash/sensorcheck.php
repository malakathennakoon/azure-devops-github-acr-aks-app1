            ...
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    <div class="navbar-header">
                        <a class="navbar-brand" href="#"> Sensor Status </a>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header" data-background-color="purple">
                                    <h4 class="title">View Malfunctioning Sensors</h4>
                                </div>
                                <div class="card-content">
									<iframe src="sensor_table.php" frameborder="0" scrolling="no" width=100% onload="resizeIframe(this)" ></iframe>
                                    <div id="typography">
                                        <div class="title">
                                        </div>
                                    </div>
