...
require_once("config.php"); 
	...
	$bin = array();
         $firstNearest = 'MLB-10-PA';
        $secondNearest = 'KDU-01-BI';
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////	 
		...
		$sql25 = "SELECT * sun_binLevel_tbl WHERE binID='$secondNearest';";
				...
				{
				echo "<br>";
				//$sql = "INSERT INTO binReqFeedBack_tbl (cemail, latitude, longitude, nearBin_1, nearBin_2, biodegradable, plastic, paper, glass, BinAvailable, binconfirm) VALUES ('$email', '$lat', '$lon', '$firstNearest', '$secondNearest', '$rad1', '$rad2', '$rad3', '$rad4', '$rad5', '$yes')";
				echo "success";
				}
				else
				{
				echo "<br>";
				//$sql = "INSERT INTO binReqFeedBack_tbl (cemail, latitude, longitude, nearBin_1, nearBin_2, biodegradable, plastic, paper, glass, BinAvailable, binconfirm) VALUES ('$email', '$lat', '$lon', '$firstNearest', '$secondNearest', '$rad1', '$rad2', '$rad3', '$rad4', '$rad5', '$no')";
				echo "noo";
				}?> 